...
> ⚠️ **口径声明 (sum_13, 2026-07-27)**: 本 spec 中 0.727/0.732 为**早期单 A=141.3 口径**。
> 当前论文口径: in-sample **0.807** + 诚实 TS-CV **0.737** (分tier A + Balance, step1.7+_tscv_validation, RL_med=6.09/Q_med=44)。
...
| step1.9+_summary_report.py | ✅ 完成 | ~130 | 汇总表可重现 |
| step1.9+_summary_report.py 验证 | ✅ | — | NTU全量 R²=0.727, CV R²=0.732 |

**验收标准**: `python step1.9+_summary_report.py` 输出汇总表, NTU全量R²>0.70 ✅
